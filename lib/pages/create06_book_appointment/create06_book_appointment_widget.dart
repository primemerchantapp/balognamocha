...
class Create06BookAppointmentWidget extends StatefulWidget {
  const Create06BookAppointmentWidget({super.key});

  @override
  State<Create06BookAppointmentWidget> createState() =>
      _Create06BookAppointmentWidgetState();
}

class _Create06BookAppointmentWidgetState
    extends State<Create06BookAppointmentWidget> {
