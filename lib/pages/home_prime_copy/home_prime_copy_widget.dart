...
import 'home_prime_copy_model.dart';
export 'home_prime_copy_model.dart';

class HomePrimeCopyWidget extends StatefulWidget {
  const HomePrimeCopyWidget({super.key});

  @override
  State<HomePrimeCopyWidget> createState() => _HomePrimeCopyWidgetState();
}

class _HomePrimeCopyWidgetState extends State<HomePrimeCopyWidget>
    with TickerProviderStateMixin {
  late HomePrimeCopyModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => HomePrimeCopyModel());
