                                ...
                                child: InkWell(
                                  ...
                                  onTap: () async {
                                    ScaffoldMessenger.of(context).showSnackBar(
                                      SnackBar(
                                        content: Text(
                                          'API for Gcash or Maya to proceed on payment and ordering!',
                                          style: TextStyle(
                                                ...
                                                child: Image.network(
                                                  valueOrDefault<String>(
                                                    listViewProductsRecord
                                                        .image,
                                                    'https://prosperityprimeglobal.com/wp-content/uploads/2024/07/tropic_fulldefence-300x300.png',
                                                  ),
                                                  width: 80.0,
                                                  height: 80.0,
                                                  fit: BoxFit.cover,
