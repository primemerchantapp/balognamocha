...
class _ProfileUpdateWidgetState extends State<ProfileUpdateWidget> {
  ...
  void initState() {
    ...
    _model.onlinedomainTextController ??= TextEditingController();
    _model.onlinedomainFocusNode ??= FocusNode();
    _model.onlinedomainFocusNode!.addListener(() => safeSetState(() {}));
                                  ...
                                  children: [
                                    ...
                                    TextFormField(
                                      ...
                                      decoration: InputDecoration(
                                        ...
                                        filled: true,
                                        fillColor:
                                            (_model.mobileFocusNode?.hasFocus ??
                                                    false)
                                                ? FlutterFlowTheme.of(context)
                                                    .accent1
                                                : FlutterFlowTheme.of(context)
                                    ...
                                    TextFormField(
                                      controller:
                                          _model.onlinedomainTextController,
                                      focusNode: _model.onlinedomainFocusNode,
                                      autofocus: true,
                                      textCapitalization:
                                          TextCapitalization.words,
                                      obscureText: false,
                                      decoration: InputDecoration(
                                        ...
                                        filled: true,
                                        fillColor: (_model.onlinedomainFocusNode
                                                    ?.hasFocus ??
                                                false)
                                            ? FlutterFlowTheme.of(context)
                                                .accent1
                                      ...
                                      cursorColor:
                                          FlutterFlowTheme.of(context).primary,
                                      validator: _model
                                          .onlinedomainTextControllerValidator
                                          .asValidator(context),
                                    ),
                                    TextFormField(
                                      ...
                                      decoration: InputDecoration(
                                        ...
                                        filled: true,
                                        fillColor: (_model.addressFocusNode
                                                    ?.hasFocus ??
                                                false)
                                            ? FlutterFlowTheme.of(context)
                                                .accent1
                                    ...
                                    TextFormField(
                                      ...
                                      obscureText: false,
                                      decoration: InputDecoration(
                                        labelText: 'Describe what you do...',
                                        labelStyle: FlutterFlowTheme.of(context)
                                            .labelLarge
                                            .override(
                                              fontFamily:
                    ...
                    child: FFButtonWidget(
                      onPressed: () async {
                        ...
                        await currentUserReference!
                          ...
                          located: currentUserLocationValue,
                          qrDataSharing: _model.onlinedomainTextController.text,
                          job: _model.descriptionTextController.text,
                          shortDescription:
